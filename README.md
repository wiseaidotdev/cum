...
Usage: cum [OPTIONS] <COMMAND>

Commands:
  clean    Clean a file or text – makes the invisible visible, then gone [alias: c]
  inspect  Show exactly what the AI left behind, like a CSI episode [alias: i]
  help     Print help (you are here)

Options:
  -j, --json     Machine-readable JSON output (for your robots)
  -q, --quiet    Suppress all output except errors (for the antisocial)
  -h, --help     Print help
